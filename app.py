...
if menu == "🏠 Home":
    ...
    '>
        ...
        Di website ini, Anda dapat menelusuri berbagai proyek kami kerjakan; prediksi dropout, analisis e-commerce untuk mendapatkan insight trend & customer behaviour, identification of attrition rate factors dengan berbagai algoritma machine learning dan deep learning,
